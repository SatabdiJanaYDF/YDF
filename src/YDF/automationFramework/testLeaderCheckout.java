...
public class testLeaderCheckout {
...
@BeforeMethod
public void leadercheckout() throws Exception {
	// WebDriver driver= new FirefoxDriver();
	   driver.get(UAT);
       ...
       if (toolTipText.contains("Cancel check-out") )
         {
          signout();
 	      ...
 	      //Add File
 		   ...
 		   YDFFileFunction.getBrowser(driver).sendKeys("C:\\Test\\sit_keys\\teddy.lloyd+testcheckoutleader01@yourdigitalfile.com.au-www.sit.yourdigitalfile.net.ydf");
...
@Test(priority =2)
public void testAdmincancel() throws Exception {
