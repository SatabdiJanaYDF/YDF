...
@BeforeMethod
public void memCheckout() throws Exception {
	// WebDriver driver= new FirefoxDriver();
	   driver.get(UAT);
       ...
       if (toolTipText.contains("Cancel check-out") )
         {
          signout();
 	      ...
 	      //Add File
 		   ...
 		   YDFFileFunction.getBrowser(driver).sendKeys("C:\\\\Test\\\\sit_keys\\\\teddy.lloyd+testcheckoutmember01@yourdigitalfile.com.au-www.sit.yourdigitalfile.net.ydf");
